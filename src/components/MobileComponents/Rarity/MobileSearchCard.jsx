...
import NftPowers from "../../nft-powers";
import { Tab, Nav } from "react-bootstrap";
import { Context } from "Context";
import SwipButton from "../../swip-button";
import { ReactSVG } from "react-svg";
import bridgeIcon from "../../../images/bridge-icon.svg";
import mintIcon from "../../../images/mint-icon.svg";
...
const MobileSearchCard = ({
  ...
  return (
    <div className="id-card-v3" style={{ transform: "scale(0.8)" }}>
