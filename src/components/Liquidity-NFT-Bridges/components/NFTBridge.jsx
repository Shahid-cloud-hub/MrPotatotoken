...
import { NFTBridContainer } from "./LiqNFTStyle";
...
const NFTBridge = () => {
    ...
    return (
        <NFTBridContainer>
            ...
            <div className={showField.original ? "addWrap" : "select-item-1"}>
              {(isMobile || isSmallMobile) && (
                <>
                  ...
                  <button
                    ...
                    className={showField.original ? "active-color" : ""}
                  >
                    <img src={BSCImg} alt="BSC" />
                    <span>BSC</span>
                  </button>
                  <label className={showField.original ? "show" : ""}>
                    <input
                      type="number"
                      className={showField.original ? "show" : ""}
                      placeholder="10"
                    />
                  ...
                  <div className="tablet--view">
                    ...
                    {showField.showSecWithSecLast && (
                        ...
                        >
                            {(isMobile || isSmallMobile) && (
                                <>
                                    <span>Swap From ERC721 NFT:</span>
                                    <button
                                        onClick={() =>
                                            setShowField((prevState) => ({
                                                ...prevState,
