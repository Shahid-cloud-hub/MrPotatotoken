...
import Wheelofprizeimg from "../../assets/images/NewHomePage/mrPotatoToken.png";
...
import CarouselResult from "./CarouselHome/CarouselResult";
...
const Wheelofprize = () => {
  ...
  function getRandomItem(arr) {
    // Filter out "0deg"
    const filteredArray = arr.filter((item) => item !== "0deg");
        ...
        <RotateWheel
          animationName={
            rotate.runSpin
              ? rotateAnimation
              : rotate.slowSpin
              ? slowRotate(items?.potatoTokenVal)
              : null
          }
