...
import { resultImagesPotatoNFT } from "./CarouselData";
import { useState } from "react";
import LogoKing from "../../../assets/images/WinSpin/logoKing.svg";
...
const CarouselResultNFT = () => {
  ...
  var reduced = resultImagesPotatoNFT.reduce(function (filtered, option) {
    if (option.deg === items?.nftVal) {
      var someNewValue = {
        name: option.name,
...
export default CarouselResultNFT;
