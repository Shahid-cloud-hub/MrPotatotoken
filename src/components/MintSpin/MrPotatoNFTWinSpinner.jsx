...
import Wheelofprizeimg from "../../assets/images/NewHomePage/mrPotatoNFT.png";
...
import CarouselResultNFT from "./CarouselHome/CarouselResultNFT";
...
const MrPotatoNFTWinSpinner = () => {
  ...
  function getRandomItem(arr) {
    // Filter out "0deg"
    const filteredArray = arr.filter((item) => item !== "360deg");
...
export default MrPotatoNFTWinSpinner;
