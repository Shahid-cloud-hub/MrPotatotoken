...
import TermsandCondition from "../TermsandCondtion/TermsandCondition";
  ...
  return (
    <>
      <TermsandCondition
        ...
        this policy so You can understand what type of cookies We use, or the information 
        We collect using Cookies and how that information is used. 
        ...
        in and obtained from Cookies. For further information on how We use, store and keep 
        ...
        1.1 “Company” (referred to as either "the Company", "We", "Us" or "Our" in this Cookies 
        Policy) refers to MrPotatoNFT.com
        1.2 “Cookies” means small files that are placed on your computer, mobile device or 
        any other device by a website, containing details of your browsing history on that 
        website among its many uses.
        1.3 “Website” refers to MrPotatoNFT.com, accessible from https://MrPotatoNFT.com/
        1.4 “You” means the individual accessing or using the Website, or a company, or any 
legal entity on behalf of which such individual is accessing or using the Website, 
as applicable.
The use of the Cookies /Type of Cookies We Use
